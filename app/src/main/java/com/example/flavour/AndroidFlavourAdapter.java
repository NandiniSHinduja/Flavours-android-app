...
public class AndroidFlavourAdapter  extends ArrayAdapter<AndroidFlavour> {
    private static final String LOG_TAG = AndroidFlavourAdapter.class.getSimpleName();
     ...
     */
    public AndroidFlavourAdapter(Activity context, ArrayList<AndroidFlavour> androidFlavors) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        AndroidFlavour currentAndroidFlavor = getItem(position);
